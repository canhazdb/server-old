...
Arguments:
  --tls-ca           required     The certificate authority to use for the certs
  --tls-cert         required     The public certificate for the server
  --tls-key          required     The private key for the server

  --host             optional     The host to bind the server on (default: localhost)
  --port             optional     The port to bind the server on (default: 7060)

  --http-host        optional     The host to bind the http server on (default: off)
  --http-port        optional     The port to bind the http server on (default: off)

  --web-host         optional     The host to bind the web html gui server on (default: off)
  --web-port         optional     The port to bind the web html gui server on (default: off)
...
async function main () {
  ...
  if (!argv['tls-ca'] || !argv['tls-cert'] || !argv['tls-key']) {
    throw new Error('all tls-ca, tls-cert and tls-key arguments must be provided');
  }
