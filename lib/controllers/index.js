...
import factoryNotifyOn from './shared/notifyOn.js';
import factoryNotifyOff from './shared/notifyOff.js';
...
const controllers = {
  internal: {
    ...
    [c.NOTIFY_ON]: factoryNotifyOn('internal'),
    [c.NOTIFY_OFF]: factoryNotifyOff('internal')
  },
  external: {
    [c.INFO]: externalInfo,
    [c.POST]: externalPost,
    ...
    [c.NOTIFY_ON]: factoryNotifyOn('external'),
    [c.NOTIFY_OFF]: factoryNotifyOff('external')
  }
};
